package caoyuanxiao.mynews.http.manager;
...
import caoyuanxiao.mynews.base.BaseSchedulerTransformer;
import caoyuanxiao.mynews.bean.NeteastNewsDetail;
import caoyuanxiao.mynews.bean.NeteastNewsSummary;
import caoyuanxiao.mynews.bean.NeteastVideoSummary;
import caoyuanxiao.mynews.bean.SinaPhotoDetail;
import caoyuanxiao.mynews.bean.SinaPhotoList;
import caoyuanxiao.mynews.bean.WeatherInfo;
import caoyuanxiao.mynews.http.Api;
import caoyuanxiao.mynews.http.HostType;
import caoyuanxiao.mynews.http.service.NewsService;
import caoyuanxiao.mynews.utils.NetUtil;
