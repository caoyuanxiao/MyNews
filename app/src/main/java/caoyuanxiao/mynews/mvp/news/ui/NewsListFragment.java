...
import caoyuanxiao.mynews.base.BaseRecyclerAdapter;
import caoyuanxiao.mynews.base.BaseRecyclerViewHolder;
import caoyuanxiao.mynews.base.BaseSpacesItemDecoration;
import caoyuanxiao.mynews.bean.NeteastNewsSummary;
import caoyuanxiao.mynews.bean.SinaPhotoDetail;
import caoyuanxiao.mynews.callback.OnEmptyClickListener;
import caoyuanxiao.mynews.callback.OnItemClickAdapter;
import caoyuanxiao.mynews.callback.OnLoadMoreListener;
import caoyuanxiao.mynews.constant.DataLoadType;
import caoyuanxiao.mynews.mvp.news.presenter.INewsListPresenter;
import caoyuanxiao.mynews.mvp.news.presenter.INewsListPresenterImp;
import caoyuanxiao.mynews.mvp.news.view.INewsListView;
import caoyuanxiao.mynews.utils.ClickUtils;
import caoyuanxiao.mynews.utils.GlideUtils;
import caoyuanxiao.mynews.utils.MeasureUtil;
import caoyuanxiao.mynews.widget.refresh.RefreshLayout;
import caoyuanxiao.mynews.widget.refresh.ThreePointLoadingView;
...
public class NewsListFragment extends BaseFragment<INewsListPresenter> implements INewsListView {
    ...
    protected void initView(View fragmentRootView) {
        ...
        mPresenter = new INewsListPresenterImp(this, mNewsId, mNewsType);
