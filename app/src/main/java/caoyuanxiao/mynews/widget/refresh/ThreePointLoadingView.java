package caoyuanxiao.mynews.widget.refresh;
...
public class ThreePointLoadingView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mBallPaint.setColor(typedArray.getColor(R.styleable.ThreePointLoadingView_pointColor, ContextCompat.getColor(context, R.color.colorAccent)));
            typedArray.recycle();
        }
